...
import com.tt.jbead.controllers.PictureController;
...
@RestControllerAdvice(assignableTypes = PictureController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
