...
import com.tt.jbead.controllers.MessageAppController;
...
@RestControllerAdvice(assignableTypes = MessageAppController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
public class MessageAppControllerAdvice {
