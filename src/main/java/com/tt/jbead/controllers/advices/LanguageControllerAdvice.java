...
import com.tt.jbead.controllers.LanguageController;
...
@RestControllerAdvice(assignableTypes = LanguageController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
