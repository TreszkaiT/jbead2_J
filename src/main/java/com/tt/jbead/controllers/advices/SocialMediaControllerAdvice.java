...
import com.tt.jbead.controllers.SocialMediaController;
...
@RestControllerAdvice(assignableTypes = SocialMediaController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
