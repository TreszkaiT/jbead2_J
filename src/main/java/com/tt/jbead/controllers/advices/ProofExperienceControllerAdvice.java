...
import com.tt.jbead.controllers.ProofExperienceController;
...
@RestControllerAdvice(assignableTypes = ProofExperienceController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
public class ProofExperienceControllerAdvice {
