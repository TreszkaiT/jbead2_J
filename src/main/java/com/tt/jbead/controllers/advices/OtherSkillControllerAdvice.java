...
import com.tt.jbead.controllers.OtherSkillController;
...
@RestControllerAdvice(assignableTypes = OtherSkillController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
public class OtherSkillControllerAdvice {
