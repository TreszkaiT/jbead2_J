...
import com.tt.jbead.controllers.CityController;
...
@RestControllerAdvice(assignableTypes = CityController.class)          // (assignableTypes = MovieController.class) :: e nélkül az összes Controller fájlért ő felel
